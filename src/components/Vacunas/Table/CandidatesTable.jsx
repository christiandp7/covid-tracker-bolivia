...
function CandidatesTable({ data: { data, phases, source, totalCandidates } }) {
  ...
  const phaseColFormater = (cell, row) => {
    ...
    return (
      <Badge style={{ backgroundColor: phaseColors.color }}>
        {vaccinePhaseText(cell)}
      </Badge>
    );
  };
  ...
  const columns = [
    ...
    { dataField: "candidate", text: "Candidatos", align: "left" },
    {
      ...
      text: "Patrocinadores",
      align: "left",
      formatter: listColFormater,
      style: { verticalAlign: "top" },
    },
    {
      dataField: "trialPhase",
      text: "Fase de Prueba",
      align: "left",
      formatter: phaseColFormater,
    },
    {
      ...
      <CardHeader>
        <Row>
          <Col className="text-left" sm="8" xs="12">
            <h5>
              Total Candidatos: {totalCandidates} | Fuente:{" "}
          ...
          <Col sm="4" xs="12">
            <FormGroup className="float-sm-right">
              ...
              >
                {phases.map((phase, i) => {
                  return (
                    <option key={i} value={phase.phase}>
                      {vaccinePhaseText(phase.phase)}
                    </option>
                  );
                })}
